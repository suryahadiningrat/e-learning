                ...
                <div class="row">
                            ...
                            <select class="form-select" id="kelas_id" name="kelas_id">
                                ...
                                <?php foreach ($kelas ?? [] as $kelas_item): ?>
                                    <option value="<?= $kelas_item['id'] ?>" 
                                            <?= (old('kelas_id', $absensi['kelas_id'] ?? '') == $kelas_item['id']) ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select <?= session('errors.siswa_id') ? 'is-invalid' : '' ?>" 
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= session('errors.keterangan') ? 'is-invalid' : '' ?>" 
                                      ...
                                      placeholder="Keterangan tambahan (opsional)"><?= old('keterangan', $absensi['keterangan'] ?? '') ?></textarea>
...
<script>
// Data absensi yang sedang diedit
...
document.getElementById('kelas_id').addEventListener('change', function() {
    ...
    // Reset siswa dan jadwal
    siswaSelect.innerHTML = '<option value="">Pilih Siswa</option>';
    jadwalSelect.innerHTML = '<option value="">Pilih Jadwal</option>';
    
    if (kelasId) {
        // Load siswa
        fetch(`<?= base_url('admin/absensi/get-siswa-by-kelas') ?>/${kelasId}`)
        ...
        // Load jadwal
        fetch(`<?= base_url('admin/absensi/get-jadwal-by-kelas') ?>/${kelasId}`)
            .then(response => response.json())
            .then(data => {
                data.forEach(jadwal => {
                    const option = document.createElement('option');
