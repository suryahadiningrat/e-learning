...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= base_url('admin/siswa/export-jurusan/' . $jurusan['id']) ?>" class="btn btn-success btn-sm">
                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="d-flex gap-1">
                                    <a href="<?= base_url('admin/siswa/export-kelas/' . $kls['id']) ?>" 
                                       class="btn btn-success btn-sm" title="Export Excel">
                                        <i class="fas fa-file-excel fa-sm"></i>
                                    </a>
                                    <a href="<?= base_url('admin/siswa/kelas/' . $kls['id']) ?>" 
